...
exports.ChannelsViewProvider = void 0;
...
class ItemNode extends vscode.TreeItem {
    ...
    constructor(item) {
        ...
        this.contextValue = kind === "dir" ? "zzza.item.dir" : "zzza.item.file";
        this.iconPath = new vscode.ThemeIcon(kind === "dir" ? "folder" : "file");
    }
}
class ChannelsViewProvider {
    ...
    async ensureCache() {
        ...
        const sortedChannels = new Map([...grouped.entries()]
            .sort(([a], [b]) => a.localeCompare(b))
            .map(([ch, list]) => [
            ch,
            list.sort(([a], [b]) => a.localeCompare(b)),
        ]));
        this.cache = { channels: sortedChannels };
    ...
    async getChildren(element) {
        ...
        if (grouped.size === 0) {
            return [
                new vscode.TreeItem("No channels yet (add slices in slice.jsonc)", vscode.TreeItemCollapsibleState.None),
            ];
        }
        if (!element) {
...
exports.ChannelsViewProvider = ChannelsViewProvider;
